---------------------------------------------------------------------------------------
Welcome to raylib 6.0
---------------------------------------------------------------------------------------

raylib is a simple and easy-to-use library to enjoy videogames programming.

raylib installer package for Windows provides all the required tools preconfigured 
to start coding games/graphics/tools/dashboards with raylib in a few seconds.
...
Directory is self-contained and portable, including all required tools:
 ...
 - raylib 6.0 library with source code, examples and several preconfigured projects
    > https://github.com/raysan5/raylib
 - Notepad++ 8.9.3 64bit (npp) 64bit preconfigured with some scripts to compile raylib and examples
    > https://github.com/notepad-plus-plus/notepad-plus-plus
 - w64devkit 2.7.0 (GCC 15.2.0 - 64bit), portable C and C++ Development Kit for Windows
    > https://github.com/skeeto/w64devkit
 - emsdk 5.0.6 - Emscripten C compiler for WebAssembly
